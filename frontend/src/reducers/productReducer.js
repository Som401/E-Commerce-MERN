...
export const productsReducer = (state = { products: [], loading: false, isCached: false, cachedAt: null }, { type, payload }) => {
    ...
    switch (type) {
        ...
        case SLIDER_PRODUCTS_REQUEST:
            return {
                ...state,
                loading: true,
                // Preserve products if already cached to avoid flash of empty state
                products: state.isCached ? state.products : [],
            };
        ...
        case SLIDER_PRODUCTS_FAIL:
            return {
                loading: false,
                error: payload,
                products: state.products || [], // Preserve products on error
